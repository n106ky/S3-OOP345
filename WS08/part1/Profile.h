...
namespace sdds {
	...
	struct Profile {
		...
		/*
		+ Add a validateAddress() function to the Profile type.
			- Your function reports an exception if the address’s number is negative
			- or postal code does not follow ANA NAN format.
		+ Your function receives no parameters.
		*/
